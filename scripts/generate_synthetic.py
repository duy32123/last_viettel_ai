...
def main():
    ...
    print(json.dumps(generate(int(cfg.get("seed",13)), cfg.get("counts",{}), Path(cfg.get("output_dir","data/processed")), cfg.get("kb_paths"), bool(cfg.get("strict_candidates", False))), ensure_ascii=False))
